...
calc_ent <- function(prod, reac, use_hdata = TRUE) {
  if (use_hdata) {
    # Load the hdata dataset
    hdata <- EcoTherm::hdata

    # Check if inputs are formulas or names
    ...
    # Check if all products and reactants were found
    ...
    # If hdata is not used, convert input to numeric
